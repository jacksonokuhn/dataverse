 ...
 */
/*
class CreateDatasetProv extends ProvCommand {

    private final String orginator;
    private final String name;
    private final String agent;
    private final String parentName;
    private final String transformation;
    
    public CreateDatasetProv(String originator, String name, String agent){
    ...
    public CreateDatasetProv(String originator, String name, String agent, String parentName, String transformation){
        ...
        CPLEdge wasAttrTo = pF.createWasAttributedTo(byAgent, createdDataset);
        CPLEdge usd = pF.createUsed(parentName, transformation);
        CPLEdge wasGenBy = pF.createWasGeneratedBy(transformation, parentName);
    }  
}
*/
...
public class CreateDatasetCommand extends AbstractCommand<Dataset> {
    ...
    // TODO: add PROV to creation of dataset in CreateDatasetCommand function
    // probably will use was generated by, and was used by and such
    ...
    public Dataset execute(CommandContext ctxt) throws CommandException {
        ...
        String name = theDataset.getIdentifier() + "1.0";
        String agent = getUser().getIdentifier();
        String parentName = "fromUI";
        String transformation = "fromUI";
    
        if (parentName == null || transformation == null) {
            CreateDatasetProv(originator, name, agent);
        }
        else {
            CreateDatasetProv(originator, name, agent, parentName, transformation);
        }
        
        msg("CPLObject.lookup("+"originator: "+ originator+", name: "+name+", type: entity");
        msg("agent: "+agent);
        ...
        */
        ...
        /*
        msg("3DOI: " + theDataset.getIdentifier());
        msg("ID test: " + getUser().getIdentifier());
        msg("Current Installation" + ctxt.systemConfig().getDataverseSiteUrl());
        /* 
        ProvFactory pF = new ProvFactory(originator);
        
        pF.setBundle(originator, theDataset.getIdentifier());
        
        String parentOriginator = "comesfromUI";
        ...
        CPLObject parentDataset = CPLObject.lookup(originator, name, "entity");
        CPLObject childDataset = pF.newEntity(theDataset.getIdentifier());
        ...
        */
        ...
        if (importType==null || importType.equals(ImportType.NEW)) {  
            ...
            msg("DataverseUser...: " +  au.getIdentifier());
            msg("DataverseUser...: " +  au.getIdentifier());
